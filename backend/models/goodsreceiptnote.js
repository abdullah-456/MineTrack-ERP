...
module.exports = (sequelize, DataTypes) => {
  ...
  GoodsReceiptNote.init({
    ...
    grn_document_path: { type: DataTypes.STRING(500), allowNull: true },
    grn_document_name: { type: DataTypes.STRING(255), allowNull: true },
    grn_document_mime: { type: DataTypes.STRING(100), allowNull: true },
    grn_document_description: { type: DataTypes.TEXT, allowNull: true },
    invoice_document_path: { type: DataTypes.STRING(500), allowNull: true },
    invoice_document_name: { type: DataTypes.STRING(255), allowNull: true },
    invoice_document_mime: { type: DataTypes.STRING(100), allowNull: true },
    invoice_document_description: { type: DataTypes.TEXT, allowNull: true },
  }, {
    sequelize,
