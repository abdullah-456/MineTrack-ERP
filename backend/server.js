...
const heavyMachineryRoutes = require('./routes/heavyMachineryRoutes');
...
app.use('/api/truck-loading', truckLoadingRoutes);
app.use('/api/leave', leaveRoutes);
app.use('/api/holidays', holidayRoutes);
app.use('/api/vehicles', vehicleRoutes);
app.use('/api/workshops', workshopRoutes);
app.use('/api/heavy-machinery', heavyMachineryRoutes);
