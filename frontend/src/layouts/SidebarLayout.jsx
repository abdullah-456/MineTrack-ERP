...
import {
  ...
  Store, Pickaxe, CircleDot, Layers, Factory, Gem, Crown, RotateCcw, Receipt, KeyRound, ShieldAlert, Ticket, Warehouse, ClipboardList, Calendar, CalendarCheck, CalendarOff, PartyPopper, Truck, FileText, Wrench, Forklift } from 'lucide-react';
...
const shopNavGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/heavy-machinery', icon: Forklift, labelKey: 'heavyMachinery', module: 'heavy_machinery', action: 'read' },
    ]
  },
  {
