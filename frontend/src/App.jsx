          ...
          <BrowserRouter>
            ...
            <Route element={<ProtectedRoute><SidebarLayout /></ProtectedRoute>}>
              ...
              <Route path="/admin/audit-log"
                element={<ProtectedRoute module="users" action="read"><ComingSoon title="Audit Log" /></ProtectedRoute>} />
              ...
              <Route path="/suppliers/:id"
                element={<ProtectedRoute module="suppliers" action="read"><ComingSoon title="Supplier Detail" /></ProtectedRoute>} />
              ...
              <Route path="/customers/:id"
                element={<ProtectedRoute module="customers" action="read"><ComingSoon title="Customer Statement" /></ProtectedRoute>} />
              ...
              <Route path="/payroll"
                element={<ProtectedRoute module="employees" action="read"><ComingSoon title="Payroll" /></ProtectedRoute>} />

              {/* Accounting */}
              <Route path="/accounting/chart-of-accounts"
                element={<ProtectedRoute module="accounting" action="read"><ComingSoon title="Chart of Accounts" /></ProtectedRoute>} />
              ...
              <Route path="/accounting/general-ledger"
                element={<ProtectedRoute module="accounting" action="read"><ComingSoon title="General Ledger" /></ProtectedRoute>} />
